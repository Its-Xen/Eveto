...
# from prometheus_fastapi_instrumentator import Instrumentator #! TODO: FOR TEST COMMENT OUT
import structlog
...
def create_app() -> FastAPI:
    ...
    # Instrumentator().instrument(app).expose(app, endpoint="/metrics") #! TODO: FOR TEST COMMENT OUT
